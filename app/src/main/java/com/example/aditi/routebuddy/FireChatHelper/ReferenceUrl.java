package com.example.aditi.routebuddy.FireChatHelper;
...
public class ReferenceUrl {
    ...
    public static final String FIREBASE_CHAT_URL="https://proj2-bba05.firebaseio.com"; //Your app main firebase url
