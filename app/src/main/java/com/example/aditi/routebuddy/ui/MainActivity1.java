package com.example.aditi.routebuddy.ui;
...
import com.example.aditi.routebuddy.FireChatHelper.ReferenceUrl;
import com.example.aditi.routebuddy.R;
import com.example.aditi.routebuddy.adapter.UsersChatAdapter;
import com.example.aditi.routebuddy.model.UsersChatModel;
        ...
        mConnectedListener = mFirebaseChatRef.getRoot().child(".info/connected").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (connected) {
                    ...
                    Toast.makeText(MainActivity1.this, "Connected to Firebase", Toast.LENGTH_SHORT).show();

                } else {

                    Toast.makeText(MainActivity1.this, "Disconnected from Firebase", Toast.LENGTH_SHORT).show();
